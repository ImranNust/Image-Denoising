...
def DRDNet(input_shape = (64, 64, 3),epsilon=1e-3, axis=-1, momentum=0.99,
    ...
    x = Subtract()([inputs, x])
    y = Conv2D(filters=64, kernel_size = (3,3), strides=(1,1), padding = 'same')(inputs)
    y = PReLU()(y)
    for i in range(7):
    ...
    y = Subtract()([inputs, y])   # input - noise
